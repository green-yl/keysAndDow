...
public class SourcePackage {
    ...
    public String getBucketRelPath() { return bucketRelPath; }
    public void setBucketRelPath(String bucketRelPath) { this.bucketRelPath = bucketRelPath; }
    public String getPackageExt() { return packageExt; }
    public void setPackageExt(String packageExt) { this.packageExt = packageExt; }
    ...
    public void setExtractedPath(String extractedPath) { this.extractedPath = extractedPath; }
